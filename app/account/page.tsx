...
export default function AccountPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8E7]">
      ...
      <div className="relative h-[240px] bg-[url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/My_Account_1_optimized-BQ54TpCe7c1r59PxPZf4bycwVhMbbt.png')] bg-cover bg-center">
